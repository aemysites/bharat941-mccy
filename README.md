...
## Environments
- Preview: https://main--bharat941-mccy--aemysites.aem.page/
- Live: https://main--bharat941-mccy--aemysites.aem.live/
...
1. Open the `bharat941-mccy` directory in your favorite IDE and start coding :)
